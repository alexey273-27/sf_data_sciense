...
#### 4 Очистка данных
Здесь мы ишем пропуски в данных удаляем либо сами заполняем какимето значениями. Удоляем дублирующие данные, неинформативные данные, выбросы, явно ложные данные итд. 
